  ...
  return (
    <div className="flex justify-center w-[70%]">
      <form onSubmit={handleSubmit} className='bg-white p-5 rounded-[10px] shadow-md flex flex-col gap-3'>
         ...
         <input value={formData.age} onChange={handleChange} name='age' required type="text" placeholder='age' className='py-[8px] indent-3 focus:border-blue-500 border-[1px] border-slate-300 outline-none shadow-md text-[18px] rounded-[5px]'/>
